...
/-!
# Statement-level audit vocabulary for the `GeneratorRenormalization` comparator

Verbatim copy of the vocabulary of `SuperdiffusionAudit/GeneratorRenormalization/Challenge.lean`
(challenge lines 93--612), Mathlib-only; a mechanical copy, not hand-edited.
-/
