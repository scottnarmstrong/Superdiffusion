...
Verbatim copy of the vocabulary of `SuperdiffusionAudit/AnomalousRegularity/Challenge.lean`
(challenge lines 105--624), Mathlib-only; a mechanical copy, not hand-edited.
-/
